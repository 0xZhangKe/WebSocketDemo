...
## 如何使用
首先将代码集成到自己的项目中，这里有两种集成方式，第一种是使用 Gradle 依赖这个项目既可，第二种把代码拷贝到自己项目中，我建议使用第二种方式，这样你觉得有什么问题自己改起来比较方便，当然了也可以直接给我[提 issue ](https://github.com/0xZhangKe/WebSocketDemo/issues/new)我来改。
### 集成
#### Gradle 方式集成
